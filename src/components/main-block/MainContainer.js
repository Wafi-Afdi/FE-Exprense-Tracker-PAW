...
function MainContainer() {
    ...
    const FormatDisplayCard = useCallback(() => {
        ...
        // hasil grouping
        const groupedData = useMemo(() => groupByDay(dataPengeluaran), [dataPengeluaran]);
        return (
            <div>
                {Object.keys(groupedData).map((dateKey) => {
                    ...
                    const dayOfWeek = moment.tz(items[0].tanggal, 'Asia/Jakarta').format('dddd');
                    //totalPengeluaran = 
    ...
    ">
        ...
        <div className='w-full grid grid-cols-6 grid-rows-2'>
            ...
            <div className='col-start-1 col-end-3 row-start-2'>
                <h2>
                    Total Pengeluaran : {"INI SEHARUSNYA DIFETCH"}
                </h2>
            </div>
        ...
        <div className='w-full flex flex-col gap-5'>
            <div className='w-full flex flex-col gap-5'>
                ...
                <button className='bg-slate-400 bg-opacity-20 h-[100px] w-full flex justify-center items-center 
                    rounded-lg
                    hover:bg-opacity-40
                '
                    type='button'
